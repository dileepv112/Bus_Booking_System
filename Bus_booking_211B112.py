#********************************************************************************************************************************************************************
                                                                   #DILEEP VISHWAKARMA[211B112] B3(BX)
#********************************************************************************************************************************************************************
...
#********************************************************************************************************************************************************************
    ...
    def intro(self):
        ...
        Label(root,text='Name: Dileep Vishwakarma',font="Arial 18 bold", fg="SpringGreen2",bg='alice blue').pack(pady=20)
             
        Label(root,text='Enrollment No: 211B112',font="Arial 18 bold", fg="SpringGreen2",bg='alice blue').pack(pady=20)
             
        Label(root,text='Mobile: 9302198620',font="Arial 18 bold", fg="SpringGreen2",bg='alice blue').pack(pady=20)
